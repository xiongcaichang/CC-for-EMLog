...
function tool_zyg() {
		document.getElementById('comment').value = document.getElementById('comment').value + '好羞射，文章真的好赞啊，顶博主！';
}
function tool_syg() {
		document.getElementById('comment').value = document.getElementById('comment').value + '博主好傻，希望下次写的简单易懂一点！';
}
function tool_qiand() {
 var myDate = new Date();
